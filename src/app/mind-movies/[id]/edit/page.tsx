  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        <Link href={`/mind-movies/${movieId}`} className="text-white/70 hover:text-white inline-flex items-center gap-2 mb-6"><ArrowLeft className="w-4 h-4" />Back to detail</Link>
        <h1 className="text-3xl font-bold mb-6">Edit Mind Movie</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <div>
            <label className="block text-sm text-white/70 mb-2">Goals (one per line)</label>
